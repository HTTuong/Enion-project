    ...
    return (
        <div className={classNames(`col-span-1 flex flex-col h-fit ${color} rounded-3xl p-4`)}>
            <div className='flex justify-center md:justify-start flex-col sm:flex-row  items-center font-normal text-black'>
                <h3 className='text-4xl sm:text-5xl md:text-7xl font-normal'>{value}</h3>
                <p className='text-2xl sm:text-3xl md:text-6xl'>{unit}</p>
            </div>
            <p className='text-sm sm:text-lg text-black text-center mt-3 sm:mt-0'>{title}</p>
            <div
